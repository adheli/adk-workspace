...
def process_refund(order_id: str, reason: str) -> dict:
    ...
    if order["status"] == "delivered":
        ...
        # Cannot refund orders that aren't yet delivered
        return {
            "status": "error",
...
def escalate_to_supervisor(issue_summary: str, order_id: str) -> dict:
    ...
    Use this when you cannot resolve the customer's issue with available tools or when the customer explicitly requests
